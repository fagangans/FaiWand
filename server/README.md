...
langsung di speaker tongkat (speech-to-speech terjadi di tongkat, bukan di server). Tidak
...
1. Server generate teks jawaban (AI4Chat/PublicAI) lalu generate audio TTS-nya (Edge Neural
   Voice), simpan sebagai file mp3 sementara di `server/public/audio/`.
